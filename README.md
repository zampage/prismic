# Prismic simeple Page

A simple page built with prismic quickstart template.

Configurable here: [prismic-playground.prismic.io](https://prismic-playground.prismic.io)
